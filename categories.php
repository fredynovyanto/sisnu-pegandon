        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-8 col-lg-10 text-center">
                    ...
                    <h1 class="page-header-title">Kategori <?= $_GET['category_name'] ?></h1>
                    <p class="page-header-text mb-5">Cari berdasarkan kategori <?= $_GET['category_name'] ?></p>
                    <form class="page-header-signup mb-2 mb-md-0" action="category_search.php" method="POST">
                        <div class="form-row justify-content-center">
                            <div class="col-lg-6 col-md-8">
                                <div class="form-group mr-0 mr-lg-2">
                                    ...
                                    <input name="category-id" value="<?= $_GET['category_id'] ?>" type="hidden" />
                                </div>
                            </div>
...
<section class="bg-white py-10">
    ...
    <div class="container">
        ...
        <hr />
        <?php
        $sql3 = "SELECT * FROM posts WHERE post_status = :status AND post_category_id = :id ORDER BY post_views DESC LIMIT 0, 1";
                ...
                <ul class="pagination pagination-blog justify-content-center">
                    ...
                    if ($prev + 1 <= 1) {
                        ...
                        echo '  <li class="page-item">
                                    <a class="page-link" href="categories.php?category_id=' . $_GET['category_id'] . '&category_name=' . $_GET['category_name'] . '&page=' . $prev . '" aria-label="Previous"><span aria-hidden="true">&#xAB;</span></a>
                                </li>';
                    }
                    ?>
                    ...
                    for ($i = 1; $i <= $total_page; $i++) {
                        if ($i == $active) {
                            echo '  <li class="page-item active">
                                        <a class="page-link" href="categories.php?category_id=' . $_GET['category_id'] . '&category_name=' . $_GET['category_name'] . '&page=' . $i . '">' . $i . '</a>
                                    </li>';
                        } else {
                            echo '  <li class="page-item">
                                        <a class="page-link" href="categories.php?category_id=' . $_GET['category_id'] . '&category_name=' . $_GET['category_name'] . '&page=' . $i . '">' . $i . '</a>
                    ...
                    if ($next - 1 >= $total_page) {
                        ...
                        echo '  <li class="page-item">
                                    <a class="page-link" href="categories.php?category_id=' . $_GET['category_id'] . '&category_name=' . $_GET['category_name'] . '&page=' . $next . '" aria-label="Next"><span aria-hidden="true">&#xBB;</span></a>
                                </li>';
                    }
                    ?>
